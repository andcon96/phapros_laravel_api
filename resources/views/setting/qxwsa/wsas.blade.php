                ...
                <form action="{{ route('qxwsa.store') }}" method="post" id="submit">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="domain" type="text" class="form-control" name="domain" autocomplete="off"
                                    value="{{ $data->wsas_domain ?? '' }}" autofocus required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="wsaurl" class="col-md-3 col-form-label text-md-right">{{ __('WSA URL') }}</label>
                            <div class="col-md-7">
                                <input id="wsaurl" type="text" class="form-control" autocomplete="off" name="wsaurl"
                                    value="{{ $data->wsas_url ?? '' }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="wsapath" type="text" class="form-control" autocomplete="off" name="wsapath"
                                    value="{{ $data->wsas_path ?? '' }}" required>
                                <span id="errorcur" style="color:red"></span>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="cb_qxenable"
                                class="col-md-6 col-form-label text-md-right">{{ __('Qxtend Enabled') }}</label>
                        ...
                        <div class="form-group row" id='rowqxpath'>
                            ...
                            <div class="col-md-7">
                                <input id="qxpath" type="text" class="form-control" name="qxpath"
                                    value="{{ $data->qx_path ?? '' }}" autofocus autocomplete="off">
