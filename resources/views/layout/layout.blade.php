        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{ url('/') }}" class="brand-logo">
                ...
                <img class="logo-abbr" src="{{ url('phapros/images/logo-white.png') }}" alt="">
                <img class="logo-compact" src="{{ url('phapros/images/logo-text-white.png') }}" alt="">
                <img class="brand-title" src="{{ url('phapros/images/logo-text-white.png') }}" alt="">
...
{{-- 
    ...
    <script src="{{ url('/phapros/vendor/peity/jquery.peity.min.js') }}"></script>

    <!-- Chartist -->
    {{-- <script src="./vendor/chartist/js/chartist.min.js"></script> --}}
    <script src="{{ url('/phapros/vendor/chartist/js/chartist.min.js') }}"></script>

    <!-- Dashboard 1 -->
    {{-- <script src="./js/dashboard/dashboard-1.js"></script> --}}
    <script src="{{ url('/phapros/js/dashboard/dashboard-1.js') }}"></script>
